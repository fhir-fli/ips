...
class IpsDataR4 {
  ...
  void _parsePatient() {
    patient =
        bundle.resourceFromBundleByReference(composition?.subject?.reference)
            as Patient?;
  }
  ...
  List<DeviceUseStatement> get medicationDevices =>
      sectionResources(IpsSection.medicationDevices)
          as List<DeviceUseStatement>;
