...
AllergyDisplay allergyDisplayFromAllergyIntoleranceR6(
...
FunctionalStatusDisplay functionalStatusDisplayFromConditionR6(
    Condition condition) {
...
FunctionalStatusDisplay functionalStatusDisplayFromClinicalImpressionR6(
  ...
  return FunctionalStatusDisplay(
    ...
    notes: clinicalImpression.summary?.value,
  );
}

ImmunizationDisplay immunizationDisplayFromImmunizationR6(
...
MedicationDeviceDisplay medicationDeviceDisplayFromDeviceUseStatementR6(
...
MedicationDisplay medicationDisplayFromMedicationStatementR6(
    MedicationStatement medicationStatement, Bundle bundle) {
  return populateMedicationDisplayR6(
...
MedicationDisplay medicationDisplayFromMedicationRequestR6(
...
MedicationDisplay populateMedicationDisplayR6({
...
PastIllnessHistoryDisplay pastIllnessHistoryDisplayFromConditionR6(
    Condition condition) {
...
PlanOfCareDisplay planOfCareDisplayFromCarePlanR6(CarePlan carePlan) {
...
ProblemDisplay problemDisplayFromConditionR6(Condition condition) {
...
ProcedureDisplay procedureDisplayFromProcedureR6(Procedure procedure) {
...
ResultDisplay resultsDisplayFromDiagnosticReportR6(
...
SocialHistoryDisplay socialHistoryDisplayFromObservationR6(
...
VitalSignDisplay vitalSignDisplayFromObservationR6(Observation observation) {
